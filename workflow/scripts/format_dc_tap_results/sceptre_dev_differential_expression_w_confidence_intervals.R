# Script: sceptre_dev_differential_expression_w_confidence_intervals.R

### SETUP =====================================================================

# Saving image for debugging
if (!file.exists("RDA_objects/sceptre_dev_differential_expression_w_confidence_intervals")) { dir.create("RDA_objects/sceptre_dev_differential_expression_w_confidence_intervals", recursive = TRUE) }
save.image(paste0("RDA_objects/sceptre_dev_differential_expression_w_confidence_intervals/", snakemake@wildcards$sample, ".rda"))
message("Saved Image")
