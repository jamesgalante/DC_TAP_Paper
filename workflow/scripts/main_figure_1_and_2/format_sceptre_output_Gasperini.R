# Script: format_sceptre_output_Gasperini.R

### SETUP =====================================================================

# Saving image for debugging
save.image(paste0("RDA_objects/format_sceptre_output_Gasperini.rda"))
message("Saved Image")
...
final_output <- data.frame(
  ...
  ci_high = 100 * (final_merged$fold_change + 1.96 * final_merged$se_fold_change),
  ci_low = 100 * (final_merged$fold_change - 1.96 * final_merged$se_fold_change),
