# Script: sceptre_differential_expression_w_mixture.R

### SETUP =====================================================================

# Saving image for debugging
if (!file.exists("RDA_objects/sceptre_differential_expression_w_mixture")) { dir.create("RDA_objects/sceptre_differential_expression_w_mixture", recursive = TRUE) }
save.image(paste0("RDA_objects/sceptre_differential_expression_w_mixture/", snakemake@wildcards$sample, ".rda"))
message("Saved Image")
